...
# Step 4: Create JMeter lib directory and download Selenium JAR
RUN powershell -Command \
    New-Item -ItemType Directory -Path $env:JMETER_HOME\lib; \
...
CMD ["cmd", "/c", "C:\\JMeter\\apache-jmeter-%JMETER_VERSION%\\bin\\jmeter.bat"]
